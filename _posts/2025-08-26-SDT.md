...
&= \frac{1}{2} ((e^{- \imath \frac{g}{\hbar} t} \frac{1}{\sqrt{2}} + e^{ \imath \frac{g}{\hbar} t} \frac{1}{\sqrt{2}}) \ket{0} + (e^{- \imath \frac{g}{\hbar} t} \frac{1}{\sqrt{2}} - e^{ \imath \frac{g}{\hbar} t} \frac{1}{\sqrt{2}})\ket{1}) \\
