...
$$
\imU \hbar \frac{d}{dt} \ket{\psi} = \hat{H} \ket{\psi},
$$

dimana $\imU = \sqrt{-1}$, $\hbar = h/2\pi$ adalah konstanta Planck tereduksi, dan $\hat{H}$ adalah Hamiltonian yang merupakan operator dari energi dari sistem. Operator energi ini memenuhi persamaan
