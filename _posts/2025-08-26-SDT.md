...
$$
\begin{align*}
O_{00} &= \tilde{O}_{00} + \tilde{O}\_{11}\\
O\_{11} &= \tilde{O}\_{00} - \tilde{O}\_{11}
\end{align*}
$$
...
$$
\begin{align*}
O_{00} \ket{0}\bra{0} + O_{11} \ket{1}\bra{1} &= (\tilde{O}_{00} + \tilde{O}\_{11}) \ket{0}\bra{0} + (\tilde{O}\_{00} - \tilde{O}\_{11}) \ket{1}\bra{1} \\
&= \tilde{O}\_{00} (\ket{0}\bra{0} + \ket{1}\bra{1}) + \tilde{O}\_{11} (\ket{0}\bra{0} - \ket{1}\bra{1})\\
&= \tilde{O}\_{00} \hat{I} + \tilde{O}\_{11} \hat{\sigma}\_\mathrm{z}, 
\end{align*}
$$
