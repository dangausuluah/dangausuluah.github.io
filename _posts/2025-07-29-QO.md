...
Maka $Y\left(\Delta \omega, T\right)$ akan bernilai $0$ ketika $\Delta \omega = \pm 2\pi/T$. Semakin besar $T$ maka $Y\left(\Delta \omega, T\right)$ semakin tajam dan detuning harus sangat kecil untuk bisa mencapai transisi ke state $\ket{k}$.
<br>
Referensi: 
