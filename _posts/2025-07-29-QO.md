...
$$
\frac{1}{2\piT} Y\left(\Delta \omega, T\right) \rightarrow \delta\left(\Delta \omega\right)
$$
...
dimana $\Delta \omega$ harus $0$ untuk bisa mendapatkan transisi karena cahayanya hanya terdiri dari frekuensi tunggal $\omega$.
<br>
Referensi: 
