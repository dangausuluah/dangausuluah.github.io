...
$$
\begin{align}
c_k &= \frac{1}{i \hbar} \int_0^T e^{-i E\_{1k} t'/ \hbar} \bra{k} \hat{H}_I \ket{1} e^{-i \omega t'} dt' \\
...
dimana $\omega_{1k} = E_{1k}/\hbar$ dan $\Delta \omega = \omega - \omega_{k1}$ disebut "detuning".
<br>
Referensi: 
