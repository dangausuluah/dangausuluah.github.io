...
$$
i \hbar \sum_n \left( \red{\dot{c}_n e^{-i E_n t/ \hbar} \ket{n} - \red{c_n\left(t\right) \frac{i E_n}{\hbar} e^{-i E_n t/ \hbar} \ket{n} }\right)
=
\sum_n \left(
  c_n\left(t\right) E_n e^{-i E_n t/ \hbar} \ket{n} + c_n\left(t\right) e^{-i E_n t/ \hbar} \hat{H}_I \ket{n}
\right)
$$
